...
#
# Cornucopia
cards = %w(hamlet fortune_teller menagerie farming_village horse_traders remake harvest hunting_party fairgrounds)
# tournament young_witch horn_of_plenty jester
