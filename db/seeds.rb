...
# Intrigue
cards = %w(great_hall duke harem coppersmith conspirator shanty_town bridge courtyard pawn secret_chamber)
# masquerade steward swindler wishing_well baron ironworks mining_village scount minion saboteur torturer trading_post tribute upgrade nobles
