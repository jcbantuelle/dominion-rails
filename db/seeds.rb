...
#
# Prosperity
cards = %w(loan trade_route watchtower bishop monument quarry talisman workers_village city contraband counting_house mint mountebank rabble royal_seal venture grand_market hoard bank kings_court peddler)
# vault goons expand forge
