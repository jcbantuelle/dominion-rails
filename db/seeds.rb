...
#
# Cornucopia
cards = %w(hamlet fortune_teller menagerie farming_village horse_traders harvest hunting_party fairgrounds)
# remake tournament young_witch horn_of_plenty jester
