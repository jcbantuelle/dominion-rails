...
#
# Hinterlands
cards = %w(crossroads duchess nomad_camp silk_road cache highway ill_gotten_gains)
# fools_gold develop oasis oracle scheme tunnel jack_of_all_trades noble_brigand spice_merchant trader cartographer embassy haggler inn mandarin margrave stables border_village farmland
