...
# Base set
cards = %w(village woodcutter gardens smithy council_room festival laboratory market witch adventurer moneylender chapel cellar bureaucrat)
# moat chancellor workshop feast militia remodel spy thief throne_room library mine
