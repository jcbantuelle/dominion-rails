...
#
# Prosperity
cards = %w(loan trade_route bishop monument workers_village venture bank grand_market quarry city peddler hoard talisman kings_court)
# watchtower contraband counting_house mint mountebank rabble royal_seal vault goons expand forge
