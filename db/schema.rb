...
ActiveRecord::Schema.define(version: 20140116000547) do
  ...
  create_table "turns", force: true do |t|
    ...
    t.integer "contraband"
    t.boolean "royal_seal",      default: false
    t.integer "goons",           default: 0
  end
